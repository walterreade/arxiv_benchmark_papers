...
This script:
1. Reads JSON files from 1st_pass_json where both is_llm_related and is_bias_related are true
2. Uploads the corresponding PDF to Gemini for analysis
3. Extracts bias_targets list and primary_bias_target
4. Saves results to 2nd_pass_json
"""
...
def main():
    parser = argparse.ArgumentParser(description="2nd pass: Extract bias targets from LLM+bias papers.")
    ...
    parser.add_argument("--json_dir", default="json/2nd_pass_json", help="Directory to save 2nd pass JSON analysis")
