...
def main():
    ...
    parser.add_argument("--json_dir", default="2nd_pass_json", help="Directory containing JSON analysis files")
    parser.add_argument("--output", default="benchmark_analysis.md", help="Output markdown file")
    parser.add_argument("--csv", default="1st_pass_results.csv", help="Input CSV file with paper metadata")
    parser.add_argument("--learnings", default="benchmark_learnings.md", help="Output learnings markdown file")
    parser.add_argument("--summary", default="benchmark_summary.md", help="Output summary markdown file")
