...
\midrule
Gender bias & 3,927 & 30.6\% & 902 & 7.0\% \\
Racial/Ethnic bias & 2,612 & 20.3\% & 145 & 1.1\% \\
Language bias & 1,677 & 13.0\% & 760 & 6.0\% \\
Religious bias & 1,374 & 10.7\% & 34 & 0.26\% \\
Cultural bias & 1,364 & 10.6\% & 600 & 4.7\% \\
Age bias & 1,324 & 10.3\% & --- & --- \\
Political bias & 1,162 & 9.0\% & 376 & 2.9\% \\
...
Religious bias is the 4th most frequently measured category overall (10.7\%), appearing at roughly the same rate as cultural and age bias. Yet when we examine primary focus studies, religion drops dramatically. Only 34 papers (0.26\% of the total papers studying bias) primarily focus on religious bias, the lowest ratio of primary-focus to incidental-measurement of any major bias category. For comparison, gender bias is the primary focus of 23\% of the papers that attempt to measure it (902 out of 3,927), while religious bias is the primary focus of only 2.5\% of the papers that attempt to measure it (34 out of 1,374).
...
\begin{table}[htbp]
\centering
\caption{Languages evaluated across 1,374 studies. The majority of studies evaluating religious bias in LLMs used English for the prompts.}
\label{tab:languages}
\begin{tabular}{lrr}
\toprule
...
\citet{santurkar2023} demonstrated that aligned LLMs disproportionately reflect the values of WEIRD populations---a consequence of using primarily Western annotators for RLHF.  Models default to Western, secular frameworks when discussing religion:
\begin{itemize}
...
This gap is not merely academic. Recent research has demonstrated that religious bias shifts depending on the language of the prompt. Models exhibit different anti-Muslim biases when prompted in Hindi versus English \cite{saeed2025surfacing}; they favor Hindu-associated cultural terms over Muslim-associated ones in Bengali despite Muslims being the majority of Bengali speakers \cite{kabir2026xcrbench}; and frontier models change their sectarian preferences between Sunni and Shia Islam depending on whether questions are asked in English, Hindi, or Arabic \cite{maheshwari2026}.
...
This paper has presented the most comprehensive analysis to date of religious bias research in Large Language Models. By systematically reviewing over 12,000 papers measuring bias and fairness in LLMs, we have demonstrated that religious bias occupies an unusual position within the literature: it is the 4th most frequently measured category of bias, yet it is the primary focus of only 0.26\% of papers, the lowest ratio of any major bias category. The 34 papers that primarily focus on religious bias comprise a tiny fraction of the attention devoted to an issue that affects billions of religious individuals worldwide.
